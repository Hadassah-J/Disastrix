<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="secondary_email" value="{{ __('Secondary email') }}" />
            <x-input id="secondary_email" type="email" class="mt-1 block w-full" wire:model="state.secondary_email" required autocomplete="username" />
            <x-input-error for="email" class="mt-2" />
